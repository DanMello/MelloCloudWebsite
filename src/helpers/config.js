export function checkHostName (hostname) {
  ...
  else if (hostname === 'mellocloud.com') config = { url: 'https://api.mellocloud.com', device: 'desktop', enviroment: 'production', isMobile: false }
  else if (hostname === 'm.mellocloud.com') config = { url: 'https://api.mellocloud.com', device: 'mobile', enviroment: 'production', isMobile: true }
